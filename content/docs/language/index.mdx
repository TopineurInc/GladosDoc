...
# On Linux/macOS
curl -sSL https://raw.githubusercontent.com/TopineurInc/Glados/refs/heads/main/install.sh | bash
```

```bash tab="Using wget"
# On Linux/macOS
wget -qO- https://raw.githubusercontent.com/TopineurInc/Glados/refs/heads/main/install.sh | bash
```
  </Step>
  <Step>
Verify installation :
